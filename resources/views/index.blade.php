        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <div class="hero-left">
                        <img src="assets/images/Gajah Lampung.jpg" alt="Gedung UNTIRTA" class="img-fluid">
                    </div>
                </div>
                <div class="col-lg-6 order-lg-1">
                    <div class="hero-content pe-lg-5">
                        <h2 class="wow fadeInUp" data-wow-delay=".2s">
                            ...
                            <span class="text-primary">Fakultas Teknik UNTIRTA</span>
                        </h2>
                        ...
                        <div class="hero-btns">
                            <a href="/daftarruang" class="main-btn wow fadeInUp" data-wow-delay=".6s" style="text-decoration: none;">
                                Ajukan Peminjaman
...
<style>
    ...
    .feature-icon {
      ...
      height: auto;
        ...
        <br> Universitas Sultan Ageng Tirtayasa
    </p>
                    </div>
                </div>
            </div>
